...
* Overall this distribution is to be as expected, since only one team can win each round, especially where each round can hold approximately 100 players
